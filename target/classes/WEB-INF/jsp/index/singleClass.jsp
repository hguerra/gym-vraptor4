...
<!-- inicio -->
<div class="main">
       <div class="about_banner_img"><img src="<%=request.getContextPath()%>/assets/images/single_class.jpg" class="img-responsive" alt=""/></div>
		   ...
		   <div class="row single-top">
				<div class="col-md-8">
				 <div class="single_class-left">
				  <img src="<%=request.getContextPath()%>/assets/images/s1.jpg" alt=""/>
				  <div class="singe_desc">
				    ...
				    <ul class=single_grid>
				    	<li class="grid1">
				    	  ...
				    	  <img src="<%=request.getContextPath()%>/assets/images/s2.jpg" class="img-responsive" alt=""/>
