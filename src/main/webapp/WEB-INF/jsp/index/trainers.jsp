...
<!-- inicio -->
<div class="main">
	  <div class="about_banner_img"><img src="<%=request.getContextPath()%>/assets/images/trine_img.jpg" class="img-responsive" alt=""></div>
	  <div class="about_banner_wrap">
       ...
       <div class="container">
       	<div class="sap_tabs">	
	        ...
	        <script src="<%=request.getContextPath()%>/assets/js/easyResponsiveTabs.js" type="text/javascript"></script>
