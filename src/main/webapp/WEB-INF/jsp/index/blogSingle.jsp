...
<!-- inicio -->
<div class="main">
       <div class="about_banner_img"><img src="<%=request.getContextPath()%>/assets/images/blog_single.jpg"  class="img-responsive" alt=""/></div>
		 <div class="about_banner_wrap">
		  ...
		  <div class="row single-top">
		  	   <div class="col-md-8">
				  ...
				  <ul class="links_blog">
				  	<h3><a href="blog_single.jsp">Lorem ipsum dolor sit amet, consectetuer adipiscing elit,sed </a></h3>
				  ...
				  <img src="<%=request.getContextPath()%>/assets/images/blog_single1.jpg" class="img-responsive" alt=""/>
			   ...
			   <div class="col-md-4">
					...
					<ul class="single_times">
					  ...
					  <div class="course_demo">
				          <ul id="flexiselDemo3">	
							<li><img src="<%=request.getContextPath()%>/assets/images/pic4.jpg" /><div class="desc">
							...
							<li><img src="<%=request.getContextPath()%>/assets/images/pic5.jpg" /><div class="desc">
